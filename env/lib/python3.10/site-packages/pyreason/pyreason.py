...
def filter_and_sort_nodes(interpretation, labels: List[str], bound=None, sort_by: str='lower', descending: bool=True):
...
def filter_and_sort_edges(interpretation, labels: List[str], bound=None, sort_by: str='lower', descending: bool=True):
